// Seed em JavaScript puro — roda com `node prisma/seed.mjs`, sem precisar do tsx.
// Usa o @prisma/client e o bcryptjs que ja estao no container.
...
async function main() {
  ...
  const users = [
    { name: "Gestor Geral", email: "gestao@buildflow.com", role: "GESTAO", salesModel: null },
    { name: "Vanessa Varejo", email: "vendas@buildflow.com", role: "VENDAS", salesModel: "VAREJO" },
    { name: "Valdir Atacado", email: "vendas2@buildflow.com", role: "VENDAS", salesModel: "ATACADO" },
    { name: "Fernando Financeiro", email: "financeiro@buildflow.com", role: "FINANCEIRO", salesModel: null },
    { name: "Lucas Logistica", email: "logistica@buildflow.com", role: "LOGISTICA", salesModel: null },
    { name: "Marcos Motorista", email: "motorista@buildflow.com", role: "MOTORISTA", salesModel: null },
    { name: "Mateus Motorista", email: "motorista2@buildflow.com", role: "MOTORISTA", salesModel: null },
  ];
  ...
  const payStatuses = [
    { name: "Pago", disposition: "APROVA" },
    { name: "Liberado (Credito)", disposition: "APROVA" },
    { name: "Transferencia", disposition: "APROVA" },
    { name: "Troca", disposition: "APROVA" },
    { name: "Estorno", disposition: "INTERROMPE" },
    { name: "Estorno Parcial", disposition: "INTERROMPE" },
    { name: "Cancelado", disposition: "INTERROMPE" },
  ];
  ...
  console.log("Seed concluido. Login: senha padrao 123456");
